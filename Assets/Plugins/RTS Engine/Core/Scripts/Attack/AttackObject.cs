...
namespace RTSEngine.Attack
{
    public class AttackObject : EffectObject, IAttackObject
    {
        ...
        private Vector3 TargetPosition => Data.target.IsValid() 
            ? (Data.target.Health.AttackTargetPosition.IsValid() ? Data.target.Health.AttackTargetPosition : Data.target.Selection.transform.position)
            : Data.targetPosition;
