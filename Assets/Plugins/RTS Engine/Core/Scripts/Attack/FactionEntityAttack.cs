...
namespace RTSEngine.EntityComponent
{
    public abstract class FactionEntityAttack : FactionEntityTargetProgressComponent<IFactionEntity>, IAttackComponent
    {
        ...
        protected override bool CanEnableProgress() => CanStartAttackIteration();

        public bool CanStartAttackIteration() 
            => isAttackReady
        ...
        protected override void OnDrawGizmosSelected()
        {
            ...
            if (HasTarget && showAttackIterationGizmos)
            {
                ...
                float minAttackDistance = Formation.GetStoppingDistance(Target.instance, min: true);
                float maxAttackDistance = Formation.GetStoppingDistance(Target.instance, min: false);
