...
namespace RTSEngine.Cameras
{
    ...
    public abstract class MainCameraRotationHandlerBase : MonoBehaviour, IMainCameraRotationHandler
    {
        ...
        private SmoothSpeedRange rotationSpeed = new SmoothSpeedRange { valueRange = new FloatRange(30.0f, 50.0f), acceleration = 10.0f, deceleration = 5.0f };
        ...
        public void Apply()
        {
            ...
            LastRotationValue = Vector2.MoveTowards(
                LastRotationValue,
                currRotationValue,
                Time.deltaTime * (currRotationValue == Vector2.zero ? rotationSpeed.deceleration : rotationSpeed.acceleration));
