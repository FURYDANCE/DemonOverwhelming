...
namespace RTSEngine.Cameras
{
    public abstract class MainCameraPanningHandlerBase : MonoBehaviour, IMainCameraPanningHandler
    {
        ...
        private SmoothSpeedRange panningSpeed = new SmoothSpeedRange { valueRange = new FloatRange(18.0f, 20.0f), acceleration = 10.0f, deceleration = 5.0f };
        ...
        public void Apply()
        {
            ...
            else
            {
                ...
                LastPanDirection = Vector3.MoveTowards(
                    LastPanDirection,
                    currPanDirection,
                    Time.deltaTime * (currPanDirection == Vector3.zero ? panningSpeed.deceleration : panningSpeed.acceleration));
